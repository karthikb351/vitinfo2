...
public class SubjectDetails extends SherlockActivity {
		...
		public void onClick(View v) {
			...
			switch (v.getId())
			{
				...
				case R.id.atten_details_button:
					...
					lv.setAdapter(new AttenAdapter(SubjectDetails.this, R.layout.single_item_atten, listAtt, start));
					lv.smoothScrollToPosition(6);
	...
	class AttBuilder
	{
		...
		{
			String newPattern="dd-MMM-yyyy", pattern="EEE, dd-MMM", result="Error";
