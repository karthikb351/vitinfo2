...
public class DownloadAttenDetails extends SherlockActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		details.add(0,regno);
		details.add(1,dob);
		details.add(2, i.getStringExtra("sub"));
	...
	private class LoadAttendanceTask extends AsyncTask<ArrayList <String>, Void, String>
	{
		...
		protected void onPreExecute() {
		  	...
		  	pdia = new ProgressDialog(DownloadAttenDetails.this);
	        pdia.setMessage("Loading Attendance Details");
		...
		protected String doInBackground(ArrayList <String>... params) {
			...
			String urldisplay = "http://vitacademics.appspot.com/det/"+details.get(0)+"/"+details.get(1)+"/"+details.get(2);
			url=urldisplay;
			try {
		...
		protected void onPostExecute(String result) {
			...
			//Toast.makeText(DownloadAttenDetails.this, "due to url :"+url, Toast.LENGTH_LONG).show();
